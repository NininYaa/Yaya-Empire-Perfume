                      ...
                      <?php if(count($allproducts) > 0) : ?>
                        <?php foreach($allproducts as $products) : ?>
                          <tr class="mb-4">
                            ...
                            <td class="pro_price"><?php echo $products->pro_price; ?></td>
                            ...
                            <td class="total_price"><?php echo $products->pro_price * $products->pro_amount; ?></td>
                            <td><button value="<?php echo $products->id; ?>" class="btn-update btn btn-warning text-white"><i class="fas fa-pen"></i> </button></td>

                            <td><button value="<?php echo $products->id; ?>" class="btn btn-danger text-white btn-delete"><i class="fas fa-trash-alt"></i> </button></td>
                          </tr>
                      <?php endforeach; ?>
                    <?php else : ?>
