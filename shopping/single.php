                        ...
                        <div class="col-md-6">
                            <div class="product p-4">
                                ...
                                <div class="mt-4 mb-3"> 
                                    ...
                                    <div class="price d-flex flex-row align-items-center"> <span class="act-price">RM<?php echo $products->price; ?></span>
                                    </div>
                                </div>
                                <p class="about"><?php echo $products->description; ?></p>
                                    <form method="post" id="form-data">
                                        <div class="">
                                            <input type="hidden" name="pro_id" value="<?php echo $products->id; ?>"  class="form-control">
                                        </div>
                                        <div class="">
                                            <input type="hidden" name="pro_name" value="<?php echo $products->name; ?>" class="form-control">
                                        </div>
                                        <div class="">
                                            <input type="hidden" name="pro_image" value="<?php echo $products->image; ?>" class="form-control">
                                        </div>
                                        <div class="">
                                            <input type="hidden" name="pro_price" value="<?php echo $products->price; ?>" class="form-control">
                                        </div>
                                        <div class="">
                                            <input type="hidden" name="pro_amount" value="1" class="form-control">
                                        </div>
                                        <div class="">
                                            <input type="hidden" name="pro_file" value="<?php echo $products->file; ?>" class="form-control">
                                        </div>
                                        ...
                                        <div class="cart mt-4 align-items-center">
                                            <?php if(isset($_SESSION['user_id'])) : ?>
                                                ...
                                                <?php else : ?>
                                                    <button id="submit" name="submit" type="submit"  class="btn btn-primary text-uppercase mr-2 px-4"><i class="fas fa-shopping-cart"></i> Added to cart</button>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
                                    </form>
