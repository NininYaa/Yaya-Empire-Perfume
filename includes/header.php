<?php 
    ...
    define("APPURL", "http://localhost/YayaEmpire");
...
<html lang="en">
  <head>
    ...
    <title>Yaya Empire</title>
  </head>
  <body>

    <nav class="navbar navbar-expand-lg navbar-light bg-dark" >
    <div class="container" style="margin-top: none">
        <a class="navbar-brand  text-white" href="<?php echo APPURL; ?>">YAYA EMPIRE</a>
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <!--<li class="nav-item">
            <a class="nav-link active  text-white" aria-current="page" href="<?php echo APPURL; ?>/review.php">Review</a>
            </li>-->
           ...
           <li class="nav-item">
            ...
            <?php if(isset($_SESSION['username'])) : ?>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                   <!-- <li><a class="dropdown-item" href="<?php echo APPURL; ?>/orders.php?id=<?php echo $_SESSION['user_id']; ?>">Orders</a></li>
